...
const RecentWork = () => {
  return (
    <div className="flex flex-col justify-center items-center my-16 overflow-x-hidden">
      ...
      <button className="font-satoshi flex items-center justify-center rounded-lg border border-solid border-gray-600 py-4 px-14 text-center text-xl font-semibold leading-[normal] tracking-[-0.32px] text-gray-500 [box-shadow:inset_2px_4px_10px_0px_rgba(203,_203,_203,_0.2)] mt-14">
